...
```bash
uv add "agent-workspace-tools @ git+https://github.com/CodeCentury22/agent-workspace-tools.git@v0.2.2"
```
...
```toml
[tool.uv.sources]
agent-workspace-tools = { git = "https://github.com/CodeCentury22/agent-workspace-tools.git", tag = "v0.2.2" }
```
